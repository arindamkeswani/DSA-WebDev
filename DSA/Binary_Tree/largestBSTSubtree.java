...
public class Main {
  ...
  public static BSTSolver isBinaryST(Node node){
      if(node==null){
        //   return new BSTSolver(Integer.MIN_VALUE,Integer.MAX_VALUE, true);
         
              BSTSolver bp=new BSTSolver();
      ...
      BSTSolver lp = isBinaryST( node.left);
      BSTSolver rp = isBinaryST( node.right);
      
      BSTSolver mp=new BSTSolver();
  ...
  public static void main(String[] args) throws Exception {
    ...
    BSTSolver obj = isBinaryST(root);
    System.out.println(obj.lbstroot.data+"@"+obj.lbstsize);
  }
