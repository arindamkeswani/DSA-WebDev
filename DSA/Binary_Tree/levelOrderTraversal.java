...
public class Main {
  ...
  public static void levelOrder(Node node) {
    ...
    // make 2 queues, one main and one helper. Add 1 level elements in main, and each element's children in helper
    //Remove and print mainQ elements, change reference of main and helper queue, and go to next iteration
