...
public class Main {
  ...
  public static int height(Node node) {
    // write your code here
    if(node==null){
        // return 0;  //if we go according to nodes, it will return one extra height unit but we will consider edges
        return -1; //the null node is "below ground", then its height should be less tham the zero level
    }
