...
public class Main {
  ...
  public static void printKLevelsDown(Node node, int k){
    ...
    if(k==0){ //this if block is placed here for preorder execution
        System.out.println(node.data);
        return;
    }
    printKLevelsDown(node.left, k-1); //value of k is decreased
    printKLevelsDown(node.right, k-1); //value of k is decreased
  }
