...
public class Main {
  ...
  public static void predecessorAndSuccessor(Node node, int data) {
    ...
    // do a preorder traversal, on encountering the given value, increase the state, otherwise keep updating value of predecessor till value is found 
    //On encountering it, update successor and exit program
    if(state==0){
        if(node.data==data){
            state=1;
        }else{
