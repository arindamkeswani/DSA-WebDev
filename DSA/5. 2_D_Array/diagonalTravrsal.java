// The historic state of Wakanda has various monuments and souveniers which are visited by many travellers every day. The guides follow a prescribed route of visiting the monuments which improves them understand the relevance of each monument. 
// The route of the monument is fixed and expressed in a 2-d matrix where the travellers visit the prescribed next monument. For example
// 1  2  3
// 4  5  6
// 7  8  9
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int j=0;j<n;j++){ //column
            for(int i=0,k=j;i<n && k<n;i++,k++){ //row
