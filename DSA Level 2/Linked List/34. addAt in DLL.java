...
//which index do you want to go to after inserting value

if(idx<0 || idx>size){ //no ==size condition
    indexIsInvalidException(idx, 0, size-1);
    // return -1;
}
if(idx==0){
    addFirst(val);
...
class Main {
  ...
  public static class DoublyLinkedList {
    ...
    public void addAt(int index, int data) {
        ...
        if(index<0 || index>size){ //no ==size condition
            indexIsInvalidException(index, 0, size);
