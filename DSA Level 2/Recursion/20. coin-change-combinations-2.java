...
public class Main {
    ...
    public static void coinChange(int i, int[] coins, int amtsf, int tamt, String asf) {
        ...
        // In combination, once selected, we dont revisit it, but in permutation, we visit all again
        ...
        //Either coin helps settle the amt(till it exceeds amount) or it does not, and we move to next coin
