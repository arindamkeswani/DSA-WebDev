...
Last element of every level in vertical order
_______________________________________
...
public class Main {
    ...
    public static ArrayList<Integer> BottomView(TreeNode root) {
        ...
        // ArrayListArrayList<Integer>> ans= new ArrayList<ArrayList<<Integer>>();
        ...
        for(int i=minhl; i<=maxhl; i++){
            fin.add(map.get(i).get(map.get(i).size()-1));
        }
